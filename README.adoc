...
:link-repository: https://github.com/d4l-data4life/hc-objc-util-kmp
ifdef::env-github[]
...
<div align="center">
    ...
    <p>
        <a href="https://github.com/d4l-data4life/hc-objc-util-kmp"><strong>Explore the docs »</strong></a>
    </p>
    <p>
        <a href="https://github.com/d4l-data4life/hc-objc-util-kmp/issues">Report Bug</a>
        ·
        <a href="https://github.com/d4l-data4life/hc-objc-util-kmp/issues">Request Feature</a>
    </p>
    <p><!-- PROJECT BADGES see badges.adoc how to change them -->
        <a href="https://github.com/d4l-data4life/hc-objc-util-kmp/releases">
            <img src="assets/images/badge-release-latest.svg" alt="Latest version"/>
        </a>
        <a href="https://github.com/d4l-data4life/hc-objc-util-kmp/actions">
            <img src="https://github.com/d4l-data4life/hc-objc-util-kmp/actions/workflows/d4l-ci-latest-version.yml/badge.svg" alt="Build Status"/>
        </a>
        <a>
...
allprojects {
    repositories {
        ...
        maven {
            url = URI("https://maven.pkg.github.com/d4l-data4life/hc-objc-util-kmp")
            credentials {
...
----
dependencies {
    implementation "care.data4life.hc-objc-util-kmp:util:$version"
}
----
