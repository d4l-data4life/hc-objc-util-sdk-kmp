...
<div align="center">
    <p>
        <a href="https://github.com/d4l-data4lifehc-objc-util-sdk-kmp">
    ...
    <p><!-- PROJECT BADGES see badges.adoc how to change them -->
        ...
        <a href="https://github.com/d4l-data4life/hc-objc-util-sdk-kmp/actions">
            <img src="https://github.com/d4l-data4life/hc-objc-util-sdk-kmp/actions/workflows/d4l-ci-latest-version.yml/badge.svg" alt="D4L CI - Latest Version"/>
        </a>
        <a>
